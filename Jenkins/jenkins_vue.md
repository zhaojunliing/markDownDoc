...
![](F:\github\markDownDoc\Jenkins\assets\jenkins_vue_01.png)

- 搜索`NodeJS`插件并进行安装；

![](F:\github\markDownDoc\Jenkins\assets\jenkins_vue_02.png)

### 配置NodeJS插件

- 在系统设置->全局工具配置中进行插件配置；

![](F:\github\markDownDoc\Jenkins\assets\jenkins_vue_03.png)

- 选择`新增NodeJS`，配置好版本号以后，点击保存即可完成设置；

![](F:\github\markDownDoc\Jenkins\assets\jenkins_vue_04.png)
...
![](F:\github\markDownDoc\Jenkins\assets\jenkins_vue_11.png)

- 构建一个自由风格的软件项目：

![](F:\github\markDownDoc\Jenkins\assets\jenkins_vue_05.png)

- 在源码管理中添加Git代码仓库相关配置，这里我使用的Gitee上面的代码，地址为：https://gitee.com/macrozheng/mall-admin-web

![](F:\github\markDownDoc\Jenkins\assets\jenkins_vue_06.png)

- 在构建环境中把我们的`node`环境添加进去：

![](F:\github\markDownDoc\Jenkins\assets\jenkins_vue_07.png)

- 添加一个`执行shell`的构建，用于将我们的前端代码进行编译打包：

![](F:\github\markDownDoc\Jenkins\assets\jenkins_vue_08.png)
...
![](F:\github\markDownDoc\Jenkins\assets\jenkins_vue_09.png)
...
![](F:\github\markDownDoc\Jenkins\assets\jenkins_vue_10.png)
